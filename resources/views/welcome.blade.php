...
<header>
    <div class="container">
        <div class="intro-text">
            ...
            <div class="intro-heading">Proctor SUST</div>
            <a href="#office" class="page-scroll btn btn-xl">Learn More</a>
        </div>
    </div>
</header>
...
<section id="universalPolicy" class="bg-light-gray">
    <div class="container">
        ...
        <div class="row">
         ...
         <a href="policy" class="page-scroll btn btn-xl">See More Policies</a>
    </div>
